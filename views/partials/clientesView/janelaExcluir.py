...
def abrir_janela_excluir_cliente(self):

    excluir_window = ctk.CTkToplevel(self.root)
    excluir_window.title("Excluir Cliente")
    ...
    cpf_excluir_label = ctk.CTkLabel(
        formulario_frame, text="CPF do cliente que deseja Excluir"
    )
    ...
    def atualizar_e_salvar_cliente():
        ...
        resultado, mensagem = controller.removerCliente(cpfExcluir)
